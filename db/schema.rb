...
ActiveRecord::Schema.define(version: 20151221000504) do
  ...
  add_index "articles", ["wiki_id"], name: "index_articles_on_wiki_id", using: :btree
  ...
  add_index "wikis", ["slug"], name: "index_wikis_on_slug", unique: true, using: :btree
